...
public class ParserTest {
    ...
    public void parsingFileTest() throws Exception {
        ...
        assertEquals(EXPECTED_MAP_FROM_FIRST_FILE, actualResultJson, "Parse.parsingFile() не получилось спарсить"
                + "строку формата JSON и получить МАР или результат не совпал с ожидаемым");
        assertEquals(EXPECTED_MAP_FROM_FIRST_FILE, actualResultYaml, "Parse.parsingFile() не получилось спарсить"
